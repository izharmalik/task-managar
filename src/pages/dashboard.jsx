        ...
        <div class="flex-col border-r mt-16 pl-5 w-1/5 bg-gray-100 h-auto">
          ...
          <div class=" px-3">
            <div class="flex py-2 px-4 cursor-pointer hover:bg-blue-100 rounded">
              <svg
                class="h-3 w-3 mt-1 text-gray-600"
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
        ...
        <div class="flex w-4/5 mt-24 h-auto">
          <div class=" ml-10 h-full" style={{ width: "400px" }}>
            ...
            <div class="flex mt-5 w-full">
              <input
                type="text"
                class="w-1/2 h-7 px-2 text-gray-500 border rounded text-xs"
                placeholder="Filter Issue ..."
              />
              <div class="items-center cursor-pointer px-2  mb-1 text-sm text-blue-500 hover:underline">
                Advanced search
              </div>
            </div>
          ...
          <div class="w-full relative ml-10  pt-32">
            <div class="absolute hover:text-blue-500 mb-64 right-0 top-0 underline cursor-pointer mr-16 mt-5 text-sm text-gray-700  font-semibold antialiased tracking-normal">
              Give feedback
            </div>
            ...
            <div class="flex overflow-auto" style={{ height: "350px" }}>
              <div class="mr-10" style={{ width: "458px" }}>
                ...
                <div class="items-center flex py-1 mt-5 text-sm font-medium text-gray-800">
                  <img
                    class="h-10 w-10 rounded-full mr-8"
                    src="https://media-exp1.licdn.com/dms/image/C4E03AQH1yPpzWPPbwA/profile-displayphoto-shrink_100_100/0/1597572102197?e=1616630400&v=beta&t=bKny37OM7-qwl1IyJQNjKOj7wSeBmDE8ScYAto5Ul3s"
                  />
                  <input
                    type="text"
                    placeholder="Add a Comment"
                    class="text-xs rounded border border-gray-500 py-2 px-2 w-full"
                  />
                </div>
              </div>
